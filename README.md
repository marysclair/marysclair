...
[![Typing SVG](https://readme-typing-svg.demolab.com/?color=B22222&width=1000&center=true&lines=Oi!+Sou+Maria+Clara;Estudante+do+quarto+período+de+ADS;Apaixonada+por+front-end;Bem+vindo(a)+ao+meu+perfil+🌹)](https://git.io/typing-svg)

## Um pouco sobre mim...
<ul>
       <li> 📌 Técnica em informática pelo IFPB - Patos </li>
        <li>📌 Quarto período em Análise e Desenvolvimento de Sistemas, IFPB - Cajazeiras </li>
        <li>📌 Tecnologias que eu curto: HTML, CSS, Javascript, Python, React, Tailwindcss </li>
        <li>📌 Estou estudando: React, Typescript, Nodejs, Nextjs </li>
        <li>📌 Pretendo estudar: Lua </li>
</ul>
